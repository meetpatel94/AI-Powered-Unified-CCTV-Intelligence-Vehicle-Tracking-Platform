    ...
    <div className="flex shrink-0 items-end justify-between gap-4">
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        <button
          ...
          className={`flex h-[30px] items-center gap-1.5 rounded-[5px] border px-2.5 text-[10.5px] font-medium transition-colors ${
            autoRefresh
        ...
        >
          {autoRefresh ? <Pause size={12} strokeWidth={2} /> : <Play size={12} strokeWidth={2} />}
          Auto Refresh
        </button>
