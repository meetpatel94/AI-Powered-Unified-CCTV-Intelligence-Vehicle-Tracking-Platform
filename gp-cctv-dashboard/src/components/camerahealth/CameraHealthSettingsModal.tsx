...
const inputCls =
  'h-[28px] w-full rounded-[4px] border border-edge bg-[#0c1424] px-2 text-[10.5px] text-ink outline-none transition-colors focus:border-accent-blue/70';
  ...
  const toggle = (key: 'autoRestart' | 'notifyCritical' | 'anprAlerts', label: string, hint: string) => (
    ...
    >
      ...
      <span className="min-w-0">
        <span className="block text-[10px] font-medium text-[#d7e1f1]">{label}</span>
        <span className="block text-[8.5px] leading-[11.5px] text-ink-faint">{hint}</span>
      </span>
    </button>
  );
    ...
    <div className="fixed inset-0 z-50 grid place-items-center bg-[#02040a]/78 p-4 backdrop-blur-[2px]" onClick={onClose} role="presentation">
      ...
      >
        <header className="flex items-center justify-between border-b border-edge bg-panel-head px-3 py-2">
          <h2 className="flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.09em] text-white">
        ...
        <div className="max-h-[70vh] space-y-3 overflow-y-auto px-3 py-2.5">
          <section>
            <p className="mb-1.5 text-[9px] font-semibold uppercase tracking-[0.09em] text-ink-faint">Stream quality thresholds</p>
          ...
          <section>
            <p className="mb-1.5 text-[9px] font-semibold uppercase tracking-[0.09em] text-ink-faint">Console</p>
            <label className="block">
          ...
          <section className="grid gap-1.5">
            <p className="text-[9px] font-semibold uppercase tracking-[0.09em] text-ink-faint">Automation</p>
          ...
          <p className="rounded-[4px] border border-edge bg-[#0a1120] px-2 py-1.5 text-[9.5px] leading-[13px] text-ink-dim">
        ...
        <footer className="flex items-center justify-between gap-2 border-t border-edge bg-panel-head px-3 py-2">
          <button
            ...
            className="flex h-[28px] items-center gap-1.5 rounded-[4px] border border-edge bg-panel px-2.5 text-[10px] font-medium text-[#c3cfe2] transition-colors hover:border-edge-strong hover:text-white"
          >
            <RotateCcw size={11} />
            Restore defaults
          </button>
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={onClose}
              className="flex h-[28px] items-center rounded-[4px] border border-edge bg-panel px-3 text-[10px] font-medium text-[#c3cfe2] transition-colors hover:border-edge-strong hover:text-white"
            >
              Cancel
            </button>
            <button
              ...
              className="flex h-[28px] items-center gap-1.5 rounded-[4px] border border-[#2f6fd0] bg-gradient-to-r from-[#1f5fd8] to-[#1a4fb5] px-3 text-[10px] font-semibold text-white shadow-[0_0_14px_-4px_rgba(47,125,255,0.8)] transition-all hover:brightness-110"
            >
