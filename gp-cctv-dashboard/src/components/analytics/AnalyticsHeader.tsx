...
const selectCls =
  'h-[30px] shrink-0 rounded-[5px] border border-edge bg-[#0c1424] pl-7 pr-2 text-[10.5px] font-medium text-[#c3cfe2] outline-none transition-colors hover:border-edge-strong focus:border-accent-blue/70';
  ...
  return (
    <div className="flex shrink-0 items-end justify-between gap-4">
      <div className="min-w-0">
        <div className="text-[8.5px] font-semibold uppercase tracking-[0.16em] text-accent-purple">
          AI Analytics &amp; Intelligence
        </div>
        <h1 className="mt-[2px] flex items-center gap-2 text-[15px] font-bold uppercase tracking-[0.1em] text-white">
      ...
      <div className="flex shrink-0 items-center gap-2">
        <label className="relative">
          <CalendarDays size={12} className="pointer-events-none absolute left-2 top-1/2 -translate-y-1/2 text-[#6d7f9e]" />
          <select
        ...
        <label className="relative">
          <Camera size={12} className="pointer-events-none absolute left-2 top-1/2 -translate-y-1/2 text-[#6d7f9e]" />
          <select
            aria-label="Camera"
            value={cameraValue}
        ...
        >
          <RefreshCw size={12} strokeWidth={2} className={refreshing ? 'animate-spin text-white' : ''} />
          Refresh
        </button>

        <span className="tnum ml-1 hidden rounded-[4px] border border-edge bg-panel px-2 py-[6px] text-[10.5px] text-[#c3cfe2] xl:inline">
          {clock}
        </span>
      </div>
    </div>
