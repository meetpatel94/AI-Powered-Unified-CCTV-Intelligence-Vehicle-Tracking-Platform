...
export function TopDetectionLocationsPanel({ locations, onSelectLocation }: TopDetectionLocationsPanelProps) {
  ...
  return (
    ...
    >
      {locations.length === 0 ? (
        <div className="grid h-full place-items-center text-[12px] text-ink-dim">No locations in this filter.</div>
      ) : (
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                <span className="flex items-center gap-1">
                  ...
                  <span className="truncate text-[12.5px] font-semibold text-[#dbe6f5]">{location.name}</span>
              ...
              <span className="flex shrink-0 flex-col items-end leading-none">
                <span className="flex items-center gap-1">
                  ...
                  <span className="tnum text-[13px] font-bold text-white">{formatIn(location.detections)}</span>
                </span>
                <span className="tnum mt-[2px] text-[9.5px] text-[#6d82a3]">
