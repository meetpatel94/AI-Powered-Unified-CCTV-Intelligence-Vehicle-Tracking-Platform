...
function Stat({
  ...
  return (
    <div className="rounded-[5px] border border-edge bg-[#0c1424] px-2 py-1.5">
      <div className="flex items-center gap-1 text-[8px] font-semibold uppercase tracking-[0.09em] text-[#6d7f9e]">
        {icon}
        <span className="truncate">{label}</span>
      </div>
      <div className={`tnum mt-[3px] truncate text-[14px] font-bold leading-none ${valueTone}`}>{value}</div>
      <div className="mt-[3px] truncate text-[8px] text-[#7f93b3]">{sub}</div>
    </div>
  );
}
    ...
    >
      ...
      <div className="shrink-0 rounded-[5px] border border-edge bg-[#0c1424] px-2 py-1.5">
        <div className="flex items-center justify-between gap-2">
          <span className="flex items-center gap-1 text-[8px] font-semibold uppercase tracking-[0.09em] text-[#6d7f9e]">
        ...
        <div className="mt-1 flex items-center gap-1.5">
          <span className="rounded-[4px] border border-edge-strong bg-[#0d1626] px-1.5 py-[2px] text-[9.5px] font-semibold text-[#dbe6f5]">
        ...
        <div className="mt-1 flex items-center justify-between text-[8.5px] text-[#7f93b3]">
          <span className="tnum">
        ...
        {legs.map((leg) => (
          <div key={`leg-${leg.index}`} className="rounded-[5px] border border-edge bg-[#0c1424] px-2 py-1">
            <div className="flex items-center gap-1.5">
              <span className="tnum rounded-[3px] bg-[#16233a] px-1 text-[8px] font-bold text-[#9fb0cc]">L{leg.index}</span>
              <span className="tnum font-mono text-[9px] font-semibold text-[#9fc7ff]">{leg.from.cameraId}</span>
              <span className="text-[9px] text-[#55668a]">→</span>
              <span className="tnum font-mono text-[9px] font-semibold text-[#9fc7ff]">{leg.to.cameraId}</span>
              <span className="tnum ml-auto text-[9px] font-bold text-white">{leg.label}</span>
            </div>
            <div className="mt-1 flex items-center gap-1.5">
              ...
              <span className="tnum shrink-0 text-[8.5px] text-[#94a5c2]">
      ...
      <p className="flex shrink-0 items-start gap-1 rounded-[4px] border border-edge-soft bg-[#0d1626] px-1.5 py-1 text-[8px] leading-[11.5px] text-[#7f93b3]">
